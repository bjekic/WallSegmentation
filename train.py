...
# Calulate the pixel accuracy between the predicted image and labeled image
...
# Saving encoder and decoder weights into a file
...
# Grouping weights and biases into individual groups for training
...
# Main function for training original encoder/decoder architecture for semantic segmentation of 150 classes, with an option to start from pretrained model, trained in  last_epoch_trained
...
# Main function for training encoder/decoder architecture for semantic segmentation only of wall
